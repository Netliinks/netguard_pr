...
export const getToken = async (mail, password) => {
    const URL = 'http://localhost:8080/oauth/token'; //'https://backend.netliinks.com:443/oauth/token';
    const ReqOptions = {
        method: 'POST',
...
export const getUserInfo = async () => {
    const userInfo = {
        url: 'http://localhost:8080/rest/userInfo?fetchPlan=full', //'https://backend.netliinks.com:443/rest/userInfo?fetchPlan=full',
        method: 'GET'
    };
    const options = {
...
export const registerEntity = async (raw, type) => {
    const req = {
        url: 'http://localhost:8080/rest/entities/', //'https://backend.netliinks.com:443/rest/entities/',
        method: 'POST'
    };
    const requestOptions = {
        method: req.method,
...
export const setPassword = async (raw) => {
    const req = {
        url: 'http://localhost:8080/rest/services/UserServiceBean/updatePassword', //'https://backend.netliinks.com:443/rest/services/UserServiceBean/updatePassword',
        method: 'POST'
    };
    const requestOptions = {
        method: req.method,
...
export const setUserRole = async (raw) => {
    const req = {
        url: 'http://localhost:8080/rest/services/UserServiceBean/assignRol', //'https://backend.netliinks.com:443/rest/services/UserServiceBean/assignRol',
        method: 'POST'
    };
    const requestOptions = {
        method: req.method,
...
export const sendMail = async (raw) => {
    const req = {
        url: 'http://localhost:8080/rest/services/UserServiceBean/sendByEmailInfo', //'https://backend.netliinks.com:443/rest/services/UserServiceBean/sendByEmailInfo',
        method: 'POST'
    }
...
export const getFile = async (fileUrl) => {
    const url = 'http://localhost:8080/rest/files?fileRef='; //'https://backend.netliinks.com:443/rest/files?fileRef=';
    const requestOptions = {
        method: 'GET',
        headers: headers,
        redirect: 'follow'
...
export const setFile = async (file) => {
    const url = `http://localhost:8080/rest/files?name=${file.name}`; //`https://backend.netliinks.com:443/rest/files?name=${file.name}`;
    const requestOptions = {
        method: 'POST',
        headers: {

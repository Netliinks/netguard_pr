...
export const tableLayout = `
  <div class="datatable" id="datatable">
    <div class="datatable_header">
      <div class="datatable_title" id="datatable-title"><h1>Horarios</h1></div>
    ...
    <table class="datatable_content">
      <thead><tr>
        ...
        <th><span data-type="timeStart">
          Inicio <i class="fa-regular fa-filter"></i>
        </span></th>

        <th><span data-type="toleranceStart">
          Tolerancia <i class="fa-regular fa-filter"></i>
        </span></th>

        <th><span data-type="timeEnd">
          Fin <i class="fa-regular fa-filter"></i>
        </span></th>

        <th><span data-type="toleranceEnd">
          Tolerancia <i class="fa-regular fa-filter"></i>
        </span></th>
